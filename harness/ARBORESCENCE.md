...
557 fichiers. Extrait tel quel de la section `harness/` d'`ARBORESCENCE.md` (racine du dépôt),
seule source vérifiée le 2026-08-18 — ce document n'en est qu'une vue locale, à régénérer depuis
la racine plutôt qu'édité à la main en cas de divergence future.
