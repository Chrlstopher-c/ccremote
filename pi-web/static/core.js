...
function switchView(view) {
  ...
  // Les deux pages de liste se rafraîchissent à l'entrée.
  if (view === 'harness-fils' && typeof hInitOrchestrateur === 'function') hInitOrchestrateur();
  if (view === 'chat-fils' && typeof renderConversationList === 'function') renderConversationList();
